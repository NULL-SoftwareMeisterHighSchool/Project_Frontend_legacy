		...
		<>
			<S.Bar>
				...
				<S.Menu>
					...
					<Option to='/blog' pagename='게시판' category={category} onSelect={onSelect}><BulletinBoard width={24} /></Option>
					<Option to='/skill' pagename='기술 블로그' category={category} onSelect={onSelect}><Computer width={24} /></Option>
					<Option to='/ranking' pagename='랭킹' category={category} onSelect={onSelect}><Trophy width={24} /></Option>
				</S.Menu>
				<S.Menu>
					<S.Subtitle>User</S.Subtitle>
					<Option to='/alarm' pagename='알림' category={category} onSelect={onSelect}><Alarm width={24} /></Option>
					<Option to='/mypage' pagename='마이페이지' category={category} onSelect={onSelect}><User width={24} /></Option>
					<Option to='/setting' pagename='설정' category={category} onSelect={onSelect}><Setting width={24} /></Option>
